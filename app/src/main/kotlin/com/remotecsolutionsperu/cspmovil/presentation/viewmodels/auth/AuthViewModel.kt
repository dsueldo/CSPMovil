package com.remotecsolutionsperu.cspmovil.presentation.viewmodels.auth
...
//    }
    ...
    fun login(email:String, password : String){
        ...
        if(email.isEmpty() || password.isEmpty()){
            _authState.value = AuthState.Error("Error isEmpty: ")
            return
        }
        ...
        auth.signInWithEmailAndPassword(email,password)
            .addOnCompleteListener{task->
                if(task.isSuccessful){
                    ...
                    _authState.value = AuthState.Error(task.exception?.message ?: "Error login")
                }
            }
    }
