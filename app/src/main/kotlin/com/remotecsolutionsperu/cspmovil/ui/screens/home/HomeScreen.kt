package com.remotecsolutionsperu.cspmovil.ui.screens.home
...
import com.remotecsolutionsperu.cspmovil.ui.screens.components.FeedComponent
...
fun HomeScreen(
    ...
    LaunchedEffect(Unit) {
        newsListViewModel.getUserProfile(token)
    }
